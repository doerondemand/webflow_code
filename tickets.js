...
setCookie('logged', JSON.stringify( {  "name" : $('#Full-Name').val() , "phone" : phonenum ,  "logged" : true, "user_type" : $('#User-Type').val() , "address" : $('#Address').val(), "city" : addobj.city,  "state" : addobj.state,  "postal_code" :  addobj.postalcode, "country" : addobj.country, "order_type" :  $('#User-Type').val() == 'customer'  ? 'customer' : 'in_process'  } ), 1)
...
console.log(cookuser.user_type)
  if( cookuser.user_type == 'warehouse' && singdat[19] == cookuser.order_type) {
	  console.log(singdat[26])
      if(singdat[26] == 'warehouse' ) {
      $(initobj.parentdivclass).append('<div role="listitem" class="ticket-list w-dyn-item"><div class="sub-ticket-div"><div class="sub-ticket-left div-block"><a href="#" class="sub-ticket-button w-button">REQUESTED</a><a href="#" class="sub-ticket-button grey accept_butt w-button" elemindex="'
+ x + '">ACCEPTED</a></div><div class="sub-ticket-price-div"><div class="sub-ticket-price-text">'+  singdat[16] 
+ '</div><div class="sub-ticket-price-text">$</div></div>   <a href="tel:+8775353637" class="help-butt w-button">Help</a>  </div>     <div class="name-sub-ticket-div"><h4>' + singdat[0] +
...
'</div><div class="ticket-address sign">$</div></div></div>   <div class="ticket-detail-div"><div class="ticket-address">Customer Phone Number</div><div class="ticket-sub-div"><div class="ticket-address right"  id="ticket_phone">'+  singdat[10] + '</div></div></div>  </div>');
  ...
  if( cookuser.user_type == 'driver') {
      ...
      $(initobj.parentdivclass).append('<div role="listitem" class="ticket-list w-dyn-item"><div class="sub-ticket-div"><div class="sub-ticket-left div-block"><a href="#" class="sub-ticket-button w-button">REQUESTED</a><a href="#" class="sub-ticket-button grey accept_butt w-button" elemindex="'+ x 
+ '">ACCEPTED</a></div><div class="sub-ticket-price-div"><div class="sub-ticket-price-text">'+  singdat[16] + 
'</div><div class="sub-ticket-price-text">$</div></div>  <a href="tel:+8775353637" class="help-butt w-button">Help</a> </div>     <div class="name-sub-ticket-div"><h4>' + singdat[0] + 
'</h4></div><div class="address-sub-div"><img src="https://global-uploads.webflow.com/6347023d711bc63c691d41dc/63c3af627239e92b81530a12_location_pin.png" loading="lazy" alt=""><div class="sub-tick-add">' +  singdat[11] +
'</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Email:</div><div class="ticket-address right">'+ singdat[9] + 
'</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Name:</div><div class="ticket-address right">'+ singdat[8] + 
