...
let singdat = homedat[x];
  if( cookuser.user_type == 'warehouse' && singdat[20] == cookuser.order_type) {
      if(singdat[27] == 'warehouse' ) {
      $(initobj.parentdivclass).append('<div role="listitem" class="ticket-list w-dyn-item"><div class="sub-ticket-div"><div class="sub-ticket-left div-block"><a href="#" class="sub-ticket-button w-button">REQUESTED</a><a href="#" class="sub-ticket-button grey accept_butt w-button" elemindex="'+ x + '">ACCEPTED</a></div><div class="sub-ticket-price-div"><div class="sub-ticket-price-text">'+  singdat[17] + '</div><div class="sub-ticket-price-text">$</div></div></div><div class="name-sub-ticket-div"><h4>' + singdat[0] +  '</h4></div><div class="address-sub-div"><img src="https://global-uploads.webflow.com/6347023d711bc63c691d41dc/63c3af627239e92b81530a12_location_pin.png" loading="lazy" alt=""><div class="sub-tick-add">' +  singdat[12] +'</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Email:</div><div class="ticket-address right">'+ singdat[10] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Name:</div><div class="ticket-address right">'+ singdat[8] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Address Details:</div><div class="ticket-address right">' + singdat[12] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Order Amount:</div><div class="ticket-sub-div"><div class="ticket-address right">'+singdat[17] + '</div><div class="ticket-address sign">$</div></div></div></div>');
      }
  }  
  if( cookuser.user_type == 'driver') {
      if(singdat[27] == 'warehouseaccepted'  && singdat[20] == cookuser.order_type ) {
      $(initobj.parentdivclass).append('<div role="listitem" class="ticket-list w-dyn-item"><div class="sub-ticket-div"><div class="sub-ticket-left div-block"><a href="#" class="sub-ticket-button w-button">REQUESTED</a><a href="#" class="sub-ticket-button grey accept_butt w-button" elemindex="'+ x + '">ACCEPTED</a></div><div class="sub-ticket-price-div"><div class="sub-ticket-price-text">'+  singdat[17] + '</div><div class="sub-ticket-price-text">$</div></div></div><div class="name-sub-ticket-div"><h4>' + singdat[0] +  '</h4></div><div class="address-sub-div"><img src="https://global-uploads.webflow.com/6347023d711bc63c691d41dc/63c3af627239e92b81530a12_location_pin.png" loading="lazy" alt=""><div class="sub-tick-add">' +  singdat[12] +'</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Email:</div><div class="ticket-address right">'+ singdat[10] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Name:</div><div class="ticket-address right">'+ singdat[8] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Address Details:</div><div class="ticket-address right">' + singdat[12] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Order Amount:</div><div class="ticket-sub-div"><div class="ticket-address right">'+singdat[17] + '</div><div class="ticket-address sign">$</div></div></div></div>');
      }
  }  
  if(cookuser.user_type == 'customer') {
	  console.log(singdat[11], cookuser.phone , singdat[10] == cookuser.phone  )
    if(singdat[11] == cookuser.phone ) {
      $(initobj.parentdivclass).append('<div role="listitem" class="ticket-list w-dyn-item"><div class="sub-ticket-div"><div class="sub-ticket-left div-block"><a href="#" class="sub-ticket-button w-button">REQUESTED</a><a href="#" class="sub-ticket-button grey accept_butt w-button" elemindex="'+ x + '">ACCEPTED</a></div><div class="sub-ticket-price-div"><div class="sub-ticket-price-text">'+  singdat[17] + '</div><div class="sub-ticket-price-text">$</div></div></div><div class="name-sub-ticket-div"><h4>' + singdat[0] +  '</h4></div><div class="address-sub-div"><img src="https://global-uploads.webflow.com/6347023d711bc63c691d41dc/63c3af627239e92b81530a12_location_pin.png" loading="lazy" alt=""><div class="sub-tick-add">' +  singdat[12] +'</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Email:</div><div class="ticket-address right">'+ singdat[10] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Name:</div><div class="ticket-address right">'+ singdat[8] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Customer Address Details:</div><div class="ticket-address right">' + singdat[12] + '</div></div><div class="ticket-detail-div"><div class="ticket-address">Order Amount:</div><div class="ticket-sub-div"><div class="ticket-address right">'+singdat[17] + '</div><div class="ticket-address sign">$</div></div></div></div>');
   }
  }
